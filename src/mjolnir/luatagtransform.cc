...
const std::string LUA_NON_WAY_NODE_PROC = "non_way_node_proc";
...
LuaTagTransform::LuaTagTransform(const std::string& lua)
{
  ...
  CheckLuaFuncExists(state_, LUA_NON_WAY_NODE_PROC);
...
Tags LuaTagTransform::NonWayNodeTransform(const Tags &maptags) {

  //grab the proper function out of the lua code
  Tags result;
  const std::string& lua_func = LUA_NON_WAY_NODE_PROC;
